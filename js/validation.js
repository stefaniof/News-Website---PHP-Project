...
function signup_validation()
{
    ...
    {
        el = document.getElementById('signup_message');
        el.innerHTML = "<div class='info-alert'>Password must be minimum 8 characters!</div>";
        return false;
    }
    else
    {
...
function change_validation()
{
	...
	{
		var firstname = document.forms["contactform"]["cfname"].value;
		var lastname = document.forms["contactform"]["clname"].value;
		var remail = document.forms["contactform"]["cemail"].value;
		...
		{
			el = document.getElementById('contact_message');
			el.innerHTML = "<div class='info-alert'>Message field is required!</div>";
			return false;
		}
		else
		{
